...
interface PartyProfileSettingsClientProps {
  profile: ProfileData;
}

export function PartyProfileSettingsClient({
  profile,
}: PartyProfileSettingsClientProps) {
  ...
  const handleSaveProfile = async () => {
    ...
    const result = await updatePartyProfile({
      full_name: fullName,
