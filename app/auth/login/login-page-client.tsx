...
function LoginForm({ signupUrl }: { signupUrl: string }) {
    ...
    <Card>
      ...
      <CardContent>
        ...
        {errorParam === "wrong-surface" && (
          <div
            role="alert"
            className="mb-4 rounded-md bg-secondary/10 p-3 text-sm text-primary"
          >
        ...
        <div className="mt-6 text-center text-sm text-muted">
          <span>¿Eres agente inmobiliario? </span>
          <a
            href={signupUrl}
...
export function LoginPageClient({ signupUrl }: { signupUrl: string }) {
  return (
